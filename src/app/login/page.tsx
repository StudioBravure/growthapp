                ...
                <CardContent>
                    ...
                    <div className="relative my-6">
                        ...
                        <div className="relative flex justify-center text-xs uppercase">
                            <span className="bg-card px-2 text-muted-foreground whitespace-nowrap">Ou continue com</span>
                        </div>
                    </div>
                    ...
                    <form action={async () => {
                        ...
                        <Button variant="outline" type="submit" className="w-full bg-background/50 border-input hover:bg-muted/50 transition-all flex items-center justify-center gap-2">
